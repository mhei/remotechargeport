...
public:
    ...
    auth_token_providerImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<SatelliteController>& mod,
                            Conf& config) :
        auth_token_providerImplBase(ev, "auth_token_provider"), mod(mod), config(config){};
...
#endif // AUTH_TOKEN_PROVIDER_AUTH_TOKEN_PROVIDER_IMPL_HPP
