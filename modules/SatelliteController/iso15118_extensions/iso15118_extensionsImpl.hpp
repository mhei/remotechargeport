...
#ifndef ISO15118_EXTENSIONS_ISO15118_EXTENSIONS_IMPL_HPP
#define ISO15118_EXTENSIONS_ISO15118_EXTENSIONS_IMPL_HPP
...
public:
    ...
    iso15118_extensionsImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<SatelliteController>& mod,
                            Conf& config) :
        iso15118_extensionsImplBase(ev, "iso15118_extensions"), mod(mod), config(config){};
...
#endif // ISO15118_EXTENSIONS_ISO15118_EXTENSIONS_IMPL_HPP
