...
authImpl::handle_withdraw_authorization(types::authorization::WithdrawAuthorizationRequest& request) {
    (void)request;
    return types::authorization::WithdrawAuthorizationResult::Rejected;
}
